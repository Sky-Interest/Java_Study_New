...
public class DDLDemo {
    ...
    public void createDatabase(){
         ...
         */
        try {
            Connection connection = DriverManager.getConnection("jdbc:mysql://localhost:3306/gec_db", "root", "root");
            //创建语句对象Statement
    ...
    public void fun2(){
        ...
        try {
            Connection connection = DriverManager.getConnection("jdbc:mysql://localhost:3306/g2405", "root", "root");
